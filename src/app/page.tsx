      ...
      <li>Skype, Slack, Asana, Trello, Jira | Clockify, RescueTime | Git, GitHub, GitLab, Bitbucket | Selenium, Postman, Jmeter | RabbitMQ, Kafka</li>
            ...
            <section className="mb-8">
                ...
                <div className="mb-4">
                    ...
                    <p className="text-gray-600">Onest Tech LLC, Banani, Dhaka, BD | 09/2022 - Current</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Lead a team of 36 developers in making critical technical decisions and implementing architectural strategies using PHP, Node, Python, JavaScript, jQuery, React, and various databases.</li>
                        <li>Oversee the successful development and deployment of full-stack applications, resulting in a 10% increase in application performance.</li>
                        <li>Architect and maintain RESTful APIs and GraphQL endpoints, improving data retrieval and exchange.</li>
                        <li>Mentored 40 developers, increasing team productivity and code quality.</li>
                    </ul>
                </div>

                <div className="mb-4">
                    <h3 className="text-xl font-semibold">Project Manager</h3>
                    <p className="text-gray-600">Onest Tech LLC, Banani, Dhaka, BD | 01/2021 - 08/2022</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Expertise in project management methodologies, including Agile, Scrum, Waterfall, and Kanban.</li>
                        <li>Strong leadership skills to guide cross-functional teams and manage stakeholder communications.</li>
                    </ul>
                </div>

                <div className="mb-4">
                    <h3 className="text-xl font-semibold">Project Manager</h3>
                    <p className="text-gray-600">Spondon IT, Panthapath, Dhaka, BD | 04/2019 - 12/2020</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Define project scope, objectives, and deliverables using PHP, Node, and Python.</li>
                    </ul>
                </div>

                <div className="mb-4">
                    <h3 className="text-xl font-semibold">Senior Software Engineer</h3>
                    <p className="text-gray-600">Spondon IT, Panthapath, Dhaka, BD | 10/2017 - 03/2019</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Lead the development using PHP (Laravel, CodeIgniter) and JavaScript.</li>
                    </ul>
                </div>

                <div className="mb-4">
                    <h3 className="text-xl font-semibold">Software Engineer</h3>
                    <p className="text-gray-600">United Group, Gulshan-2, Dhaka, BD | 01/2017 - 10/2017</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Lead end-to-end software development, from designing database schemas to implementing server-side logic.</li>
                    </ul>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <p className="text-gray-600">United Group, Gulshan-2, Dhaka, BD | 01/2017 - 10/2017</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Write, test, and maintain code for software applications using PHP, JavaScript, and MySQL.</li>
                    </ul>
                </div>

                <div className="mb-4">
                    <h3 className="text-xl font-semibold">Software Engineer, Intern</h3>
                    <p className="text-gray-600">IWFM, BUET, Polashi, Dhaka, BD | 06/2016 - 12/2016</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>Assist in designing and developing user-friendly interfaces using HTML, CSS, Bootstrap, and JavaScript.</li>
                    </ul>
                </div>
            </section>
